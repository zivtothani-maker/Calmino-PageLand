...
const translations = {
  he: {
    ...
    blog_read: "קרא עוד ←",
    blog_toggle_open: "קרא עוד", blog_toggle_close: "סגור",
    ...
    sec1_h: "התחברות מאובטחת", sec1_p: "כניסה מוגנת ומהירה לאפליקציה באמצעות זיהוי של Apple ו-Google. רק אתם נכנסים ורואים את הנתונים.",
    ...
    plus_f4: "מאגר בייביסיטרים מלא + צ'אט", plus_f5: "ייצוא PDF לרופא", plus_f6: "אבטחה והצפנה ברמה גבוהה",
  ...
  en: {
    ...
    nav_features: "The Problem", nav_tools: "Our Approach", nav_security: "Privacy & Security", nav_pricing: "Pricing", nav_cta: "Download App",
    ...
    blog_read: "Read More →",
    blog_toggle_open: "Show more", blog_toggle_close: "Show less",
    ...
    sec1_h: "Secure Authentication", sec1_p: "Secure app access with advanced login via Apple & Google. Full protection to maintain total privacy.",
    ...
    plus_f4: "Full babysitter marketplace + chat", plus_f5: "PDF export for doctor", plus_f6: "High-level security & encryption",
