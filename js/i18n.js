...
const translations = {
  he: {
    nav_features: "פיצ'רים", nav_tools: "כלים", nav_security: "אבטחה", nav_pricing: "תמחור", nav_cta: "הורדת האפליקציה",
    hero_badge: "זמין עכשיו ב-App Store",
    hero_h1a: "הורות מודרנית.", hero_h1b: "בלי העומס.",
    hero_sub: "כלים חכמים לניהול הורות יומיומית, תיעוד יומי חכם, מעקב התפתחותי מדויק וחיבור לבייביסיטרים איכותיים - שקט אמיתי מתחיל בשליטה.",
    hero_btn: "הורדה חינם", hero_btn2: "ראה תוכניות",
    hero_note: "ללא כרטיס אשראי · התקנה תוך 30 שניות · iOS & Android",
    stat1_num: "15+", stat1_label: "כלי מעקב מובנים",
    stat2_num: "WHO", stat2_label: "עקומות גדילה מבוססות תקן",
    stat3_num: "256", stat3_label: "הצפנת AES-bit",
    ...
    prob1_q: "מתי בפעם האחרונה...?", prob1_d: "כשהכל מתנהל בראש ובהודעות - קשה לעקוב, לזכור ולהיות בטוח/ה מה קרה ומה נדרש לעשות.",
    prob2_q: "בלי שיתוף מידע - אין תיאום אמיתי", prob2_d: "בלי מערכת משותפת, התיאום נשען על זיכרון ושיחות",
    prob3_q: "חוסר בעקביות מוביל לחוסר בתובנות.", prob3_d: "ללא היסטוריה וחוסר בתובנות - קושי בקבלת החלטות",
    prob4_q: "על מי אני יכול/ה לסמוך?", prob4_d: "חיפוש אחר בייביסיטר הוא תהליך מתיש - בלי היצע ברור, בלי שקיפות ובלי ודאות אמיתית.",
    pos_label: "הגישה שלנו", pos_title: "פלטפורמה אחת. שקט נפשי מוחלט.",
    pos_sub: "Calmino מרכזת את כל מה שצריך — מעקב רפואי, ניהול משפחה, ושוק בייביסיטרים — במקום אחד, עם עיצוב שמרגיש כמו חלק מהמכשיר.",
    pos1_h: "מעקב חכם", pos1_p: "טיימרים להאכלה, שינה, החתלה, תרופות וחיסונים. עם Live Activities ישירות על מסך הנעילה של iOS.",
    pos2_h: "תובנות מבוססות נתונים", pos2_p: "גרפים, דוחות שבועיים, עקומות צמיחה לפי WHO. תובנות שעוזרות לזהות דפוסים ולקבל החלטות מושכלות.",
    pos3_h: "שוק בייביסיטרים", pos3_p: "פרופילים מאומתים, ביקורות מהורים אמיתיים, צ'אט מובנה והזמנה ישירה. הכל בתוך האפליקציה.",
    ...
    ft2_label: "דוחות ותובנות", ft2_title_a: "לא סתם נתונים.", ft2_title_b: "הבנה אמיתית.",
    ft2_sub: "גרפים ויזואליים, עקומות גדילה WHO, סיכומים שבועיים, וניתוח דפוסים. ייצוא PDF לרופא הילדים בלחיצה.",
    ft2_li1: "דוחות שבועיים וחודשיים אוטומטיים עם ניתוח מגמות",
    ft2_li2: "עקומות גדילה (משקל, גובה, היקף ראש) לפי תקני WHO",
    ft2_li3: "תובנות מבוססות נתונים — לא תחושות בטן",
    ft2_li4: "ייצוא דוח PDF מפורט לשיתוף עם רופא הילדים",
    ...
    ft3_label: "שוק בייביסיטרים", ft3_title_a: "למצוא מישהו/י", ft3_title_b: "שאפשר לסמוך עליו.",
    ft3_sub: "שוק בייביסיטרים מובנה באפליקציה — עם אימות זהות, ביקורות מהורים אמיתיים, צ'אט פנימי, ומעקב הזמנות. בלי ווטסאפ. בלי מזל.",
    ...
    tools_label: "ארגז כלים", tools_title_a: "עוד 10+ כלים מובנים", tools_title_b: "שכל הורה צריך.",
    tools_sub: "Calmino היא לא סתם אפליקציית מעקב. היא פלטפורמה שלמה שמניעה עומס — מתזכורות חכמות, דרך מעקב חיסונים, ועד מנגינות שינה.",
    tool1_h: "מעקב חיסונים", tool1_p: "רשימת חיסונים מלאה לפי גיל. סמנו מה בוצע ומתי.",
    tool2_h: "תוספי תזונה", tool2_p: "מעקב ויטמין D, ברזל, ותוספים נוספים. תזכורות יומיות.",
    tool3_h: "מעקב שיניים", tool3_p: "תיעוד כל שן שבקעה. מפה ויזואלית אינטואיטיבית.",
    tool4_h: "רעש לבן", tool4_p: "מבחר צלילים מרגיעים ורעשי לבן מובנים.",
    tool5_h: "רגעים קסומים", tool5_p: "תעדו תמונות ואבני דרך. אלבום דיגיטלי שגדל עם התינוק.",
    tool6_h: "מנורת לילה", tool6_p: "מנורת לילה דיגיטלית עם צבעים מרגיעים — ישירות מהמסך.",
    tool7_h: "מצב חירום", tool7_p: "חיוג מהיר לטיפת חלב, מד\"א, ורופא הילדים.",
    tool8_h: "צ'קליסט", tool8_p: "רשימות מותאמות אישית — מעקב שינויים, ביקורים, או כל דבר.",
    sec_label: "אבטחה ופרטיות", sec_title: "המידע שלכם. רק שלכם.",
    sec_sub: "פרטיות היא לא פיצ'ר — היא עיקרון עיצוב. הנתונים של המשפחה שלכם מוגנים בסטנדרטים הגבוהים ביותר.",
    sec1_h: "נעילה ביומטרית", sec1_p: "Face ID ו-Touch ID מובנים. רק אתם נכנסים לאפליקציה ורואים את הנתונים.",
    sec2_h: "הצפנה מקצה לקצה", sec2_p: "כל הנתונים מוצפנים בהעברה (TLS 1.2+) ובאחסון. Firebase Security Rules מבטיחות שרק אתם ניגשים למידע.",
    sec3_h: "אפס מכירת מידע", sec3_p: "אנחנו לא מוכרים, משכירים, מחליפים, או משתמשים בנתונים שלכם לפרסום. אף פעם. נקודה.",
    sec4_h: "תאימות GDPR ו-COPPA", sec4_p: "עמידה מלאה בתקני פרטיות בינלאומיים ובחוק הגנת הפרטיות הישראלי. מחיקת נתונים בלחיצה.",
    ...
    price_sub: "הגרסה החינמית מכסה את כל הבסיס. הפרימיום פותח את כל היכולות — מדוחות מתקדמים ועד שוק בייביסיטרים מלא.",
    ...
    plus_f4: "שוק בייביסיטרים מלא + צ'אט", plus_f5: "ייצוא PDF לרופא", plus_f6: "נעילה ביומטרית (Face ID)",
