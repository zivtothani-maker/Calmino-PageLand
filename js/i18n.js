...
const translations = {
  he: {
    ...
    pos2_h: "תובנות מבוססות נתונים", pos2_p: "דוחות שבועיים וחודשיים, עקומות גדילה לפי WHO, ניתוח דפוסי שינה והאכלה וייצוא PDF לרופא בלחיצה.",
    pos3_h: "שוק בייביסיטרים", pos3_p: "מצאו בייביסיטרים לפי מיקום וזמינות, עיינו בפרופילים עם ניסיון והמלצות מהורים, ובחרו את הבייביסיטר המתאימה ביותר.",
