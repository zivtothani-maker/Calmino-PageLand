...
const translations = {
  he: {
    ...
    pos2_h: "תובנות מבוססות נתונים", pos2_p: "גרפים, דוחות שבועיים, עקומות צמיחה לפי ארגון הבריאות העולמי (WHO).",
    ...
    ft2_sub: "גרפים ויזואליים, עקומות גדילה לפי ארגון הבריאות העולמי (WHO), וניתוח דפוסים.",
    ft2_li1: "דוחות שבועיים וחודשיים אוטומטיים עם ניתוח מגמות",
    ft2_li2: "עקומות גדילה לפי תקני ארגון הבריאות העולמי (WHO)",
